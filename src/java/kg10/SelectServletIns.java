 ...
 * @author C0114112
 */
@WebServlet(name = "SelectServletIns", urlPatterns = {"/SelectServletIns"})
public class SelectServletIns extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            sql = "insert into T_STUDENT values(5,'工科三郎',1,1,87)";
